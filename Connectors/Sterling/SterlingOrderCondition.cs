namespace StockSharp.Sterling
{
	...
	[Serializable]
	[DataContract]
	[DisplayName("Условие заявок для Sterling")]
	public class SterlingOrderCondition : OrderCondition
	{
		...
		[DataMember]
		[Category("Стоп")]
		[DisplayName("Цена активации")]
		[Description("Цена активации, при достижении которой будет выставлена заявка.")]
		...
		[DataMember]
		[Category("Основный")]
		[DisplayName("Расширенный тип заявки")]
		[Description("Расширенный тип заявки.")]
		...
		/// </summary>
		[DisplayName("Опционы")]
		[Description("Настройки для заявок на опционы.")]
		[ExpandableObject]
