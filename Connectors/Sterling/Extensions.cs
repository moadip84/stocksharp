	...
	static class Extensions
	{
		...
		public static Sides ToSide(this string side)
		{
			switch (side)
			{
				...
				default:
					throw new ArgumentOutOfRangeException("side", side, "Неизвестное значение направления.");
			}
		}
		...
		public static TimeInForce ToTif(this string tif)
		{
			switch (tif)
			{
				...
				default:
					throw new ArgumentOutOfRangeException("tif", tif, "Неизвестное время жизни заявки.");
			}
		}
			...
			switch (type)
			{
				...
				case OrderTypes.Conditional:
				{
					...
					switch (condition.ExtendedOrderType)
					{
						...
						case null:
							throw new ArgumentException("Расширенный тип заявки не инициализирован.", "condition");
						default:
							throw new ArgumentOutOfRangeException("condition", condition.ExtendedOrderType, "Неизвестный расширенный тип заявки.");
					}
				}
				default:
